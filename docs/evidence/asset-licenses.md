...
| 절차형 아케이드 배경음 | 외부 음원·샘플 없이 Web Audio Oscillator·Gain으로 128 BPM·64-step 오리지널 스코어를 런타임 직접 합성 | `ai-prompts/2026-08-08-procedural-arcade-bgm.md` | G 장조 펜타토닉 음형과 4단계 편성 밀도, 효과음 대비 음량과 모바일 오디오 수명주기를 검토 | 게임 진행 배경음 |
