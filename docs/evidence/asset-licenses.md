...
| 절차형 아케이드 배경음 | 외부 음원·샘플 없이 Web Audio Oscillator·Gain으로 152 BPM·128-step 오리지널 스코어를 런타임 직접 합성 | `ai-prompts/2026-08-08-procedural-arcade-bgm.md` | G 장조 8마디 진행, 킥·스네어·베이스·리드와 4단계 추가 레이어, 효과음·나레이션 순간 자동 덕킹과 모바일 오디오 수명주기를 검토 | 게임 진행 배경음 |
